...
class Ui_Function(object):
    def setupUi(self, Function):
        ...
        self.newleft = QtWidgets.QLabel(self.centralwidget)
        self.newleft.setGeometry(QtCore.QRect(20, 20, 211, 31))
        self.newleft.setText("")
        self.newleft.setObjectName("newleft")
        self.reviewleft = QtWidgets.QLabel(self.centralwidget)
        self.reviewleft.setGeometry(QtCore.QRect(20, 70, 211, 31))
        self.reviewleft.setText("")
        self.reviewleft.setObjectName("reviewleft")
